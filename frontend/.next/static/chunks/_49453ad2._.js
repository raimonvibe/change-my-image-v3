...
function BillingPage() {
    ...
    const buy = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BillingPage.useCallback[buy]": async ()=>{
            setErr(null);
            setLoading(true);
            try {
                var _this;
                const params = new URLSearchParams({
                    successUrl: "".concat(window.location.origin, "/account"),
                    cancelUrl: window.location.href
                });
                const res = await fetch("".concat(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$env$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_URL"], "/api/billing/checkout?").concat(params.toString()), {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                ...
                if (!res.ok) {
                    const text = await res.text().catch({
                        "BillingPage.useCallback[buy]": ()=>''
                    }["BillingPage.useCallback[buy]"]);
                    throw new Error("Checkout failed: ".concat(res.status, " ").concat(res.statusText).concat(text ? " — ".concat(text) : ''));
                }
                let data;
                try {
                    data = await res.json();
                ...
                const url = (_this = data) === null || _this === void 0 ? void 0 : _this.url;
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: "20 free conversions per day."
                    }, void 0, false, {
                        fileName: "[project]/src/app/billing/page.tsx",
                        lineNumber: 66,
                        columnNumber: 9
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: "$1.98/month for unlimited conversions (optional monthly renewal)."
                    }, void 0, false, {
                        fileName: "[project]/src/app/billing/page.tsx",
                        lineNumber: 67,
                        columnNumber: 9
                    ...
                    err && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "mt-3 text-sm text-red-600 break-words",
                        children: err
                    }, void 0, false, {
                        fileName: "[project]/src/app/billing/page.tsx",
                        lineNumber: 78,
...
_s(BillingPage, "O5VDqEW2BQ14pBsfnIZi8d/LTSY=", false, function() {
    return [
...
//# sourceMappingURL=_49453ad2._.js.map