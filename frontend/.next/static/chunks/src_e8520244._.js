...
const api = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].create({
    baseURL: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$env$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_URL"],
    withCredentials: true
});
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
    ...
    const start = async ()=>{
        ...
        for (const j of pending){
            ...
            try {
                ...
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].post('/api/convert', form, {
                    headers: token ? {
                ...
                var _e_response, _e_response1, _e_response2;
                console.error('Conversion error:', e);
                let errorMessage = e.message;
                if (((_e_response = e.response) === null || _e_response === void 0 ? void 0 : _e_response.status) === 401) {
                    errorMessage = 'Please sign in with Google to convert.';
                } else if (((_e_response1 = e.response) === null || _e_response1 === void 0 ? void 0 : _e_response1.status) === 402) {
                    errorMessage = 'Daily limit reached (20 free conversions). Sign in and subscribe for unlimited conversions.';
                } else if (((_e_response2 = e.response) === null || _e_response2 === void 0 ? void 0 : _e_response2.status) === 403) {
                    errorMessage = 'CSRF token missing or invalid. Please refresh the page.';
                } else if (e.response) {
                    errorMessage = "Conversion failed: ".concat(e.response.status);
                }
                setJobs((prev)=>prev.map((x)=>x === j ? {
                            ...x,
                            status: 'error',
...
//# sourceMappingURL=src_e8520244._.js.map